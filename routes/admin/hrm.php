...
Route::group(['prefix' => 'hrm', 'middleware' => ['xss', 'admin', 'MaintenanceMode']], function () {
    ...
    Route::middleware(['FeatureCheck:attendance'])->group(function () {
        ...
        Route::group(['prefix' => 'attendance'], function () {
            ...
            Route::get('approve/regularization/{attendance}', [AttendanceController::class, 'approveRegularization'])->name('approve.attendance.regularization')->middleware('PermissionCheck:attendance_update');
            Route::get('reject/regularization/{attendance}', [AttendanceController::class, 'rejectRegularization'])->name('reject.attendance.regularization')->middleware('PermissionCheck:attendance_update');
