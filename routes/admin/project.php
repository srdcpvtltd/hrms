...
Route::group(['middleware' => ['xss','admin', 'TimeZone', 'FeatureCheck:projects'], 'prefix' => 'admin/project'], function () {
...
Route::group(['middleware' => ['admin', 'TimeZone', 'FeatureCheck:projects'], 'prefix' => 'admin/project'], function () {
