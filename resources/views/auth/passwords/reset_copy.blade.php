    ...
    <div class="container">
        <div class=" cus-card">
            <div class="card-body login-card-body">
                <div class="mb-4">
                    <p class="login-box-msg cus-login-box-msg mt-3">{{ _trans('auth.Change password!!') }}</p>
                </div>
                <form action="#" method="post" id="login" class="password_reset_form">
                    @csrf
                    <div class="input-group mb-3">
                        <input type="text" name="code" class="form-control"
                            placeholder="{{ _trans('auth.Verification Code') }}">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="password" placeholder="{{ _trans('auth.password') }}"
                            class="form-control">
                    </div>
