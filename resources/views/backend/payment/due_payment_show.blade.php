                ...
                <div class="col-12 col-md-12 col-lg-12 order-2 order-md-1">
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-4">
                      <div class="info-box bg-light">
                        <div class="info-box-content">
                          <span class="info-box-text text-center text-muted">{{ _trans('partial.Due Amount') }}</span>
                          <span
                    ...
                    <div class="col-lg-4 col-sm-4">
                      <div class="info-box bg-light">
                        <div class="info-box-content">
                          <span class="info-box-text text-center text-muted">{{ _trans('partial.Created Date') }}</span>
                          <span
