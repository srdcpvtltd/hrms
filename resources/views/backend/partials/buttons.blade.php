<div class="align-self-center">
    <div class="d-flex justify-content-center justify-content-xl-end align-content-center">
        ...
        <div class="dropdown dropdown-export" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="{{ _trans('common.Export') }}">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                    <a class="dropdown-item btnExcelExport" href="#" aria-current="true"><span
