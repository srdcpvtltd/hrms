                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="gift" class="form-control ot-form-control ot-input"
                                            placeholder="{{ _trans('award.Enter gift') }}" required
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="amount" class="form-control ot-form-control ot-input"
                                            placeholder="{{ _trans('common.Enter Amount') }}" id="amount" step=0.01
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="award_info"
                                            placeholder="{{ _trans('common.Enter Award Information') }}"
                                            class="form-control ot-form-control ot-input" id="award_info"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea type="text" name="content" class="form-control content" required
                                            placeholder="{{ _trans('common.Enter Description') }}">{!! @$data['edit']->description !!}</textarea>
