    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content data">
            <div class="modal-header text-center modal_headerBg_color">
                <h5 class="modal-title text-white">{{ _trans('project.This is Title') }}</h5>
            ...
            <div class="modal-body">
                <div class="row p-5">
                    <div class="col-md-12">
                        ...
                        <p>
                            <strong>{{ _trans('project.Deal Amount') }}</strong> {{ _trans('project.: 12000 Tk') }}
                        </p>
                        ...
                        <form method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="payment_method" class="form-control" required>
                                    <option value="Mama Mia">{{ _trans('project.Mama Mia') }}</option>
                                    <option value="Hell Yeah">{{ _trans('project.Hell Yeah') }}</option>
                                    <option value="Yooo Brooo">{{ _trans('project.Yoo Broo') }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="{{ _trans('common.Enter Amount') }}" name="amount" class="form-control" required>
                            </div>
                            <div class="form-group text-right">
                                <button type="submit" class="btn btn-primary pull-right"><b>{{
                                         _trans('common.Submit') }}</b></button>
                            </div>
                        </form>
