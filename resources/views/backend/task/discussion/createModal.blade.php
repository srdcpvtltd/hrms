                    ...
                    <div class="col-md-12">
                        <input type="hidden" id="form_url" value="{{ @$data['url'] }}">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" min="0" step=any name="subject" placeholder="{{ _trans('common.Enter Subject') }}" id="subject" autocomplete="off" required onkeyup="discussionValidate()"/>
                                <div class="error_show_subject"></div>
                            </div>
                            <div class="form-group">
                                <label class="form-label">{{ _trans('common.Description') }} <span class="text-danger">*</span></label>
                                <textarea type="text" placeholder="{{ _trans('common.Enter Description') }}" name="description" id="description" rows="5" class="form-control" required onkeyup="discussionValidate()">{{  old('description') }}</textarea>
                                <div class="error_show_description"></div>
                            </div>
                            <div class="form-group d-none">
                                <div class="checkbox checkbox-primary">
                                    <input type="checkbox" name="show_to_customer" value="1" checked="" id="show_to_customer" onclick="discussionValidate()" placeholder="{{ _trans('project.Visible to Customer') }}">
