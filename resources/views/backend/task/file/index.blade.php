                ...
                <div class="panel-body font-size-13">
                        ...
                        <div class="col-lg-3 col-sm-12 col-12">
                            <div class="single-post card ot-card">
                                ...
                                <div class="news-cnt mt-20">
                                    <a target="_blank" href="{{ route('task.file.download', 'task_id=' . $data['view']->id) . '&file_id=' . $data['file']->id }}"
                    ...
                    <div id="discussion-comments" class="tc-content jquery-comments">
                                                ...
                                                @if (hasPermission('task_file_comment'))
                                                    <div class="dis-{{ $comment->id }} c-none ml-70 mb-20">
                                                        <div class="form-group">
                                                            <textarea id="comment-{{ $comment->id }}" class="form-control ck_editor ot-input" row="5" col="5"> </textarea>

                                                        </div>
                                                        <div class="error-message-{{ $comment->id }}">
                                                        </div>
                                                        <div
                                                            class="form-group float-right d-flex justify-content-end mt-3">
                        ...
                        @if (hasPermission('task_file_comment'))
                            ...
                            <div class="form-group">
                                <textarea id="comment-" class="form-control ck_editor ot-input" row="5" col="5"> </textarea>
                            </div>
