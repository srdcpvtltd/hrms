                    ...
                    <div class="col-md-12">
                         <form action="{{ $data['url'] }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="description" placeholder="{{ _trans('common.Enter Description') }}" id="description" rows="5" class="form-control summernote" required >{{ @$data['edit']->description ? $data['edit']->description :  old('description') }}</textarea>
                            </div>
