                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="name" class="form-label">{{ _trans('common.Department') }}
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="designation_id"
                                                    class="form-label">{{ _trans('common.Designation') }} <span
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="#" class="form-label">{{ _trans('performance.Title') }}
                                                    <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" required
                                                    value="{{ old('title') }}"
                                                    placeholder="{{ _trans('performance.Title') }}">
                                                @if ($errors->has('title'))
