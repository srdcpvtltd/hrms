                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="month"
                                    class="form-control ot-input ot-form-control ot-input-date"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="amount" class="form-control ot-form-control ot-input"
                                    ...
                                    required step=0.01 placeholder="2000">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="recover_from"
                                    class="form-control ot-form-control ot-input ot-input-date"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form-label">{{ _trans('common.Reason') }} <span
                                        class="text-danger">*</span></label>
                                <textarea type="text" name="reason" class="form-control ot-input mt-0" placeholder="{{ _trans('common.Reason') }}"
                        ...
                        <div class="row  mt-20">
                            <div class="col-md-12">
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-gradian">Save</button>
                                </div>
                            </div>
                        </div>
                    @endif
