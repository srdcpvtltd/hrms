                    ...
                    <div class="col-lg-12">
                        <form action="{{ route('dutySchedule.update', $data['duty_schedule']->id) }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" max="60" min="0"
                                            value="{{ $data['duty_schedule']->consider_time }}" placeholder="{{ _trans('common.Enter Consider Time') }}"
                                            class="form-control ot-form-control ot-input" name="consider_time"
                                            value="0">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        <label for="#">{{ _trans('common.Start Time') }} <span
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        <label for="#">{{ _trans('common.End Time') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="time" class="form-control ot-form-control ot-input" name="end_time"
                            ...
                            <div class="row ">
                                <div class="col-md-12">
                                    <div class="text-right d-flex justify-content-end">
                                        <button type="submit" class="btn btn-gradian">{{ _trans('common.Update') }}
                                        </button>
                                    </div>
                                </div>
                            </div>
