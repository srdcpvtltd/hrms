          ...
          <div class="profile-body">
                ...
                <div class="profile-body-form">
                      ...
                      <div class="form-box">
                        <form>
                          <input
                            ...
                            type="text"
                            class="form-control"
                            placeholder="{{ _trans('check.Robert Downey JR.') }}"
                          />
                  ...
                  <div class="form-item">
                    ...
                    >
                      <div class="align-self-center">
                        <h2 class="title">{{ _trans('common.Date') }}</h2>
                ...
                <h2 class="title mt-40">{{ _trans('common.Check In') }}</h2>
                <!-- profile body form start -->
                <div class="profile-body-form">
                  <div class="form-item pt-0">
                    <div
                  ...
                  <div class="form-item">
                    ...
                    >
                      <div class="align-self-center">
                        ...
                        <p class="paragraph">{{ _trans('common.Check In location') }}</p>
                      </div>
                      <div class="align-self-center">
                        <button
                          type="button"
                ...
                <!-- profile body form end -->
                <h2 class="title mt-40">{{ _trans('common.Check Out') }}</h2>
                <!-- profile body form start -->
                <div class="profile-body-form">
                  <div class="form-item pt-0">
                    <div
                      ...
                      <div class="form-box">
                        <form>
                          <input
                            ...
                            type="time"
                            class="form-control"
                            placeholder="{{ _trans('common.Robert Downey JR.') }}"
                          />
                          <button type="button" class="btn-update">
                            {{ _trans('common.Update') }}
                          </button>
                  ...
                  <div class="form-item">
                    ...
                    >
                      <div class="align-self-center">
                        ...
                        <p class="paragraph">{{ _trans('common.Check Out location') }}</p>
                      </div>
                      <div class="align-self-center">
                        <button
                          type="button"
...
@endsection
@section('script')
    <script src="{{ url('backend/js/__location_get.js') }}"></script>
@endsection
