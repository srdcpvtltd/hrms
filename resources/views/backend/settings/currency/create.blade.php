                        ...
                        <div class="px-primary py-primary">
                            <div id="General-0">
                                <fieldset class="form-group mb-5">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form  action="{{route('manage.settings.save_currency')}}"  method="post" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input required type="text" class="form-control ot-form-control ot-input" id="name"
                                                                   name="name"  >
                                                        </div>
                                                        <div class="form-group mb-3">
