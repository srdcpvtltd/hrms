...
@section('title',   _trans('expense.Income/Expense List'))
@section('content')
                        ...
                        <div class="col-sm-12">
                            <div class="float-sm-right">
                                <a href="{{ route('income_expense.create') }}"
                                    class="btn btn-primary">{{ _trans('expense.Add Income-Expense') }}</a>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 filter-btn-margin">
                                <div class="form-group mt-2">
                                    <button type="submit" class="btn btn-primary income_expense_table_form">{{ _trans('expense.Filter') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
