                    ...
                    <div class="col-md-12">
                         <form action="{{ $data['url'] }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="description" id="description" rows="5" placeholder="{{ _trans('common.Enter Description') }}" class="form-control summernote mt-0 ot-input" required >{{ @$data['edit']->description ? $data['edit']->description :  old('description') }}</textarea>
                            </div>
                            ...
                            <div class="form-group text-right d-flex justify-content-end">
                                <button type="submit" class="btn btn-gradian mt-3 pull-right " >{{ @$data['button'] }}</button>
                            </div>
                        </form>
