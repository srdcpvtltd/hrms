                    ...
                    <div class="col-md-12">
                        <input type="hidden" id="form_url" value="{{ @$data['url'] }}">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control ot-form-control ot-input" min="0" step=any name="subject" id="subject" autocomplete="off" required placeholder="{{ _trans('common.Enter Subject') }}" onkeyup="discussionValidate()"/>
                                <div class="error_show_subject"></div>
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label">{{ _trans('common.Description') }} <span class="text-danger">*</span></label>
                                <textarea type="text" name="description" id="description" rows="5" class="form-control ot-input summernote mt-0" required onkeyup="discussionValidate()">{{  old('description') }}</textarea>
                            ...
                            <div class="form-group text-right d-flex justify-content-end">
                                <button type="button" class="btn btn-gradian pull-right" onclick="submit_discussion()" >{{ _trans('common.Submit') }}</button>
                            </div>
