                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control ot-form-control ot-input"
                                            placeholder="{{ _trans('common.Enter Name') }}" required
                                ...
                                <div
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="total_rate"
                                            ...
                                            placeholder="{{ _trans('project.Enter Total Rate') }}" step=0.01
                                ...
                                <div
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="per_rate" class="form-control ot-form-control ot-input"
                                            ...
                                            value="{{ @$data['edit']->per_rate }}" id="per_rate" step=0.01
                                            onkeyup="calculateAmount(this.value)">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="estimated_hour"
                                            ...
                                            placeholder="{{ _trans('project.Enter Estimated Hours') }}" step=0.01
                                            onkeyup="calculateAmount(this.value)">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="amount"
                                            placeholder="{{ _trans('common.Enter Amount') }}"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group ">
                                        <label class="form-label">{{ _trans('common.Description') }} <span
                                                class="text-danger">*</span></label>
                                        <textarea type="text" name="content" class="form-control content"
                                            placeholder="{{ _trans('common.Enter Description') }}" required><?= @$data['edit']->description ?> </textarea>
