                                    ...
                                    <div class="px-primary py-primary">
                                        <div role="tablist" aria-orientation="vertical" class="nav flex-column nav-pills">
                                            ...
                                            <a href="{{ route('user.profile', [$data['id'], 'official']) }}"
                                                class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.profile', [$data['id'], 'official']) ? 'active' : '' }}"><span>{{ _trans('project.Official') }}</span>
                                            ...
                                            <a href="{{ route('user.profile', [$data['id'], 'personal']) }}"
                                                class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.profile', [$data['id'], 'personal']) ? 'active' : '' }}"><span>{{ _trans('project.Personal') }}</span>
                                                <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" class="feather feather-chevron-right">
                                            ...
                                            @if (auth()->user()->role_id != 1)
                                                <a href="{{ route('user.profile', [$data['id'], 'financial']) }}"
                                                    class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.profile', [$data['id'], 'financial']) ? 'active' : '' }}"><span>{{ _trans('project.Financial') }}</span>
                                                    <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                            stroke-linejoin="round" class="feather feather-chevron-right">
                                                ...
                                                <a href="{{ route('user.profile', [$data['id'], 'emergency']) }}"
                                                    class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.profile', [$data['id'], 'emergency']) ? 'active' : '' }}"><span>{{ _trans('project.Emergency') }}</span>
                                                    <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                            stroke-linejoin="round" class="feather feather-chevron-right">
                                            ...
                                            @if (auth()->user()->is_admin == 1)
                                                <a href="{{ route('user.profile', [$data['id'], 'company']) }}"
                                                    class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.profile', [$data['id'], 'company']) ? 'active' : '' }}"><span>{{ _trans('project.Company') }}</span>
                                                    <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                            stroke-linejoin="round" class="feather feather-chevron-right">
                                                                            ...
                                                                            <div>
                                                                                @if ($data['show']->original['data']['facebook_link'])
                                                                                    <a href="{{ $data['show']->original['data']['facebook_link'] ?? 'N/A' }}"
                                                                                        target="_blank">
                                                                                        <img src="{{ global_asset('images/facebook.svg') }}"
                                                                                            alt="">
                                                                                    </a>
                                                                                @endif
                                                                                @if ($data['show']->original['data']['linkedin_link'])
                                                                                    <a href="{{ $data['show']->original['data']['linkedin_link'] ?? 'N/A' }}"
                                                                                        target="_blank">
                                                                                        <img src="{{ global_asset('images/linkedin.svg') }}"
                                                                                            alt="">
                                                                                    </a>
                                                                                @endif
                                                                                @if ($data['show']->original['data']['instagram_link'])
                                                                                    <a href="{{ $data['show']->original['data']['instagram_link'] ?? 'N/A' }}"
                                                                                        target="_blank">
                                                                                        <img src="{{ global_asset('images/instagram.svg') }}"
                                                                                            alt="">
                                                                                    </a>
                                                                                @endif
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        <label for="old_password"
                                                                            class="col-sm-2 col-form-label">{{ _trans('common.Old Password') }}</label>
                                                                        <div class="col-sm-10">
                                                                            <input type="password" class="form-control"
                                                                                name="old_password" id="old_password"
                                                                                placeholder="{{ _trans('common.********') }}">
                                                                            <small
                                                                                class="text-danger __old_password"></small>

                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="inputSkills"
                                                                            class="col-sm-2 col-form-label">{{ _trans('common.New Password') }}</label>
                                                                        <div class="col-sm-10">
                                                                            <input type="password" class="form-control"
                                                                                name="password" id="inputSkills"
                                                                                placeholder="{{ _trans('common.********') }}">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="password_confirmation"
                                                                            class="col-sm-2 col-form-label">{{ _trans('common.Confirm Password') }}</label>
                                                                        <div class="col-sm-10">
                                                                            <input type="password" class="form-control"
                                                                                ...
                                                                                placeholder="{{ _trans('common.********') }}">
                                                                            <small
                                                                                class="text-danger __password_confirmation"></small>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
