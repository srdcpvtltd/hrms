    ...
    <div class="profile-content">
        <div class="d-flex flex-column flex-lg-row gap-4 gap-lg-0">
            ...
            <div class="profile-body padding-reduce">
                <h2 class="title">{{ _trans('attendance.Attendance') }}</h2>
                                ...
                                <div class="align-self-center">
                                    <label>
                                        ...
                                        <select class="form-select d-inline-block">
                                            <option value="10">{{ _trans('attendance.10') }}</option>
                                            <option value="25">{{ _trans('attendance.25') }}</option>
                                            <option value="50">{{ _trans('attendance.50') }}</option>
                                            <option value="100">{{ _trans('attendance.100') }}</option>
                                        </select>
                                    ...
                                    <div class="align-self-center">
                                        <div class="dropdown dropdown-designation" data-bs-toggle="tooltip"
                                            ...
                                            <button type="button" class="btn-designation" data-bs-toggle="dropdown"
                                                ...
                                                <span class="d-none d-xl-inline">{{ _trans('attendance.Designation') }}</span>
                                            </button>
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <ul class="list">
                                                    <li class="list-item">
                                                        <a class="dropdown-item" href="#">{{ _trans('attendance.Main Department') }}</a>
                                                    </li>

                                                    <li class="list-item">
                                                        <a class="dropdown-item" href="#">{{ _trans('attendance.Admin & HRM') }}</a>
                                                    </li>

                                                    <li class="list-item">
                                                        <a class="dropdown-item" href="#">{{ _trans('common.Accounts') }}</a>
                                                    </li>

                                                    <li class="list-item">
                                                        <a class="dropdown-item" href="#">{{ _trans('common.Development') }}</a>
                                                    </li>

                                                    <li class="list-item">
                                                        <a class="dropdown-item" href="#">{{ _trans('attendance.Software') }}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" href="#"><span class="icon mr-8"><i
                                                            ...
                                                            {{ _trans('attendance.Copy') }}</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="#" aria-current="true"><span
                                                                class="icon mr-10"><i
                                                                    class="fa-solid fa-file-excel"></i></span>
                                                            {{ _trans('attendance.Exel File') }}</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <span class="icon mr-14"><i
                                                                    class="fa-solid fa-file-csv"></i></span>{{ _trans('attendance.Csv File') }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <span class="icon mr-14"><i
                                                                    class="fa-solid fa-file-pdf"></i></span>{{ _trans('attendance.Pdf File') }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <span class="icon mr-10"><i
                                                                    class="fa-solid fa-table-columns"></i></span>{{ _trans('attendance.Column Header') }}
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item" href="#"><span class="icon mr-10"><i
                                                        ...
                                                        {{ _trans('attendance.Make Publish') }}</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="#" aria-current="true"><span
                                                            class="icon mr-8"><i class="fa-solid fa-eye-slash"></i></span>
                                                        {{ _trans('attendance.Make Unpublish') }}</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="#">
                                                        <span class="icon mr-16"><i
                                                                class="fa-solid fa-trash-can"></i></span>{{ _trans('attendance.Delete') }}
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="align-self-center d-flex flex-wrap gap-2">
                            ...
                            <div class="align-self-center">
                                <a href="/profile-add-attendance.html" role="button" class="btn-add"
                                    ...
                                    <span class="d-none d-xl-inline">{{ _trans('attendance.Add') }}</span>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody class="tbody">
                                <tr>
                                    ...
                                    <td>{{ _trans('attendance.01') }}</td>
                                    <td>{{ _trans('attendance.July 04') }}</td>
                                    <td>{{ _trans('attendance.John Depp') }}</td>
                                    <td>{{ _trans('attendance.Design') }}</td>
                                    <td>{{ _trans('attendance.02') }}</td>
                                    <td>{{ _trans('attendance.30 Mins') }}</td>
                                    <td>
                                        <span class="badge-light-success">{{ _trans('attendance.09:25 AM') }}</span>
                                    </td>
                                    <td>
                                        <span class="badge-success">{{ _trans('attendance.06:40 PM') }}</span>
                                    </td>
                                    <td>{{ _trans('attendance.09:33 Hrs') }}</td>
                                    <td class="overtime">{{ _trans('attendance.01:33 Hrs') }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ _trans('attendance.09:33 Hrs') }}</td>
                                    <td>{{ _trans('attendance.01:33 Hrs') }}</td>
                    ...
                    <div class="ot-pagination d-flex justify-content-end align-content-center">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                ...
                                <li class="page-item">
                                    <a class="page-link active" href="#">{{ _trans('attendance.1') }}</a>
                                </li>
                                <li class="page-item">
                                    <a class="page-link" href="#">{{ _trans('attendance.2') }}</a>
                                </li>
                                <li class="page-item">
                                    <a class="page-link" href="#">{{ _trans('attendance.3') }}</a>
                                </li>
                                <li class="page-item">
