                                        ...
                                        <div class="dropdown dropdown-designation" data-bs-toggle="tooltip"
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <ul class="list">
                                                    ...
                                                    <li class="list-item">
                                                        <a class="dropdown-item" href="#">{{ _trans('common.Software') }}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <span class="icon mr-14"><i
                                                                    class="fa-solid fa-file-csv"></i></span> {{ _trans('common.Csv File') }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <span class="icon mr-14"><i
                                                                    class="fa-solid fa-file-pdf"></i></span> {{ _trans('common.Pdf File') }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <span class="icon mr-10"><i
                                                                    class="fa-solid fa-table-columns"></i></span>{{ _trans('common.Column Header') }}
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="#">
                                                        <span class="icon mr-16"><i
                                                                class="fa-solid fa-trash-can"></i></span>{{ _trans('common.Delete') }}
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
