                                ...
                                <div class="px-primary py-primary">
                                    <div role="tablist" aria-orientation="vertical"
                                        ...
                                        <a href="{{ route('staff.staffProfileEditView','official') }}"
                                           class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','official') ? 'active' : '' }}"><span>{{ _trans('common.Official') }}</span>
                                        ...
                                        <a href="{{ route('staff.staffProfileEditView','financial') }}"
                                           class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','financial') ? 'active' : '' }}"><span>{{ _trans('common.Financial') }}</span>
                                            <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                           width="24" height="24"
                                                                           viewBox="0 0 24 24" fill="none"
                                                                           stroke="currentColor" stroke-width="2"
                                            ...
                                            <a href="{{ route('staff.staffProfileEditView','emergency') }}"
                                                class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','emergency') ? 'active' : '' }}"><span>{{ _trans('common.Emergency') }}</span>
                                                <span class="active-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
                                            ...
                                            <a href="{{ route('staff.staffProfileEditView','security') }}"
                                                class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','security') ? 'active' : '' }}"><span>{{ _trans('common.Security') }}</span>
                                                <span class="active-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
                                                            ...
                                                            <div class="form-group row d-none">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="password" class="form-control" name="old_password"
                                                                           id="old_password" value="12345678" placeholder="{{ _trans('common.********') }}">
