<div class="profile-body p-40 pl-40 pr-40 pt-10">
    ...
    <div class="profile-body-form">
        ...
        <div class="form-group mt-20">
            ...
            <input type="text" class="form-control ot-form-control ot-input" name="email" value ="{{ @$data['email'] }}" placeholder="{{ _trans('common.E-mail') }}">
            @if ($errors->has('email'))
        ...
        <div class="form-group mt-20">
            ...
            <input type="password" class="form-control ot-form-control ot-input" name="old_password" placeholder="{{ _trans('common.Enter Old Password') }}">
        ...
        <div class="form-group mt-20">
            ...
            <input type="password" class="form-control ot-form-control ot-input" name="password" placeholder="{{ _trans('profile.Enter New Password') }}">
        ...
        <div class="form-group mt-20">
            ...
            <input type="password" class="form-control ot-form-control ot-input" name="password_confirmation" placeholder="{{ _trans('profile.Enter Confirm Password') }}">
