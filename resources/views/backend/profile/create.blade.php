                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <div class="form-group">
                                        <label for="image">{{ _trans('profile.Profile Picture') }}</label>
                                                ...
                                                <div>
                                                    <div class="custom-image-upload-wrapper d-flex justify-center">
                                                        ...
                                                        <div class="input-area"><label id="upload-label"
                                                                ...
                                                                {{ _trans('profile.Change Avatar') }}
                                                            </label> <input id="appSettings_company_logo" name="avatar"
                                                                type="file" class="form-control d-none" placeholder="{{ _trans('profile.Change Avatar') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="permanent_address">{{ _trans('profile.Permanent Address') }}</label>
                                        <input class="form-control" id="permanent_address" name="permanent_address"
                                            placeholder="{{ _trans('profile.Permanent Address') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="current_address">{{ _trans('profile.Current Address') }}</label>
                                        <input class="form-control " id="current_address" name="current_address"
                                            placeholder="{{ _trans('profile.Current Address') }}"
