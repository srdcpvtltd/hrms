    ...
    <div class="page-content">
        ...
        <div class="email-template">
            ...
            <div class="template-heading">
                <!-- logo  -->
                <img class="half-logo" src="{{ uploaded_asset(@base_settings('company_icon')) }}" alt="">
            </div>
            <!-- End template header  -->
            <!-- Start template body  -->
            <div class="template-body">
                ...
                <div class="content-part">
                    <p>{{ _trans('emailTemplate.Hello') }} {{ @$comapany->name }},</p>
                    <p>{{ _trans('emailTemplate.Welcome!') }}
                        <br>
                        {{ _trans('emailTemplate.Please use the below mentioned email & password as a login credential.') }}
                    </p>

                    <table class="w-100" width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td align="center" bgcolor="#f6f6f6" valign="middle" height="40"
                                    style="font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,&quot;Roboto&quot;,&quot;Oxygen&quot;,&quot;Ubuntu&quot;,&quot;Cantarell&quot;,&quot;Fira Sans&quot;,&quot;Droid Sans&quot;,&quot;Helvetica Neue&quot;,sans-serif;font-size:16px;font-weight:bold">
                                    {{ _trans('emailTemplate.Email') }}- {{ @$company->email }}
                                </td>
                                <td align="center" bgcolor="#f6f6f6" valign="middle" height="40"
                                    style="font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,&quot;Roboto&quot;,&quot;Oxygen&quot;,&quot;Ubuntu&quot;,&quot;Cantarell&quot;,&quot;Fira Sans&quot;,&quot;Droid Sans&quot;,&quot;Helvetica Neue&quot;,sans-serif;font-size:16px;font-weight:bold">
                                    {{ _trans('emailTemplate.Password') }}- {{ @$password }}
                                </td>
                                <td align="center" bgcolor="#f6f6f6" valign="middle" height="40"
                                    style="font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,&quot;Roboto&quot;,&quot;Oxygen&quot;,&quot;Ubuntu&quot;,&quot;Cantarell&quot;,&quot;Fira Sans&quot;,&quot;Droid Sans&quot;,&quot;Helvetica Neue&quot;,sans-serif;font-size:16px;font-weight:bold">
                                    {{ _trans('emailTemplate.Domain') }}- {{ @$company->subdomain }}.hrm.test
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="template-footer">
                <div class="template-footer-image">
                    <!-- logo  -->
                    <img class="full-logo" src="{{ uploaded_asset(@base_settings('company_logo_frontend')) }}"
                        alt="" />
                </div>
