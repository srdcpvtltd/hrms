        ...
        <div class="email-template">
            ...
            <div class="template-body">
                ...
                <div class="content-part">
                    <p>{{ _trans('emailTemplate.Hello') }} {{ @$user->name }},</p>
                    <p>{{ _trans('emailTemplate.Welcome!') }}
                        <br> {{ _trans('emailTemplate.Please use the below mentioned code to reset your password.') }}
                    </p>
                    ...
                    <p>
                        {{ _trans('emailTemplate.This code will expire in 15 minutes and can only be used once.') }}
                    </p>
                </div>
            </div>
            <!-- End template body -->
