        ...
        <div class="email-template">
            ...
            <div class="template-body">
                ...
                <div class="content-part">
                    <p>
						{{ _trans('emailTemplate.Hello') }} {{ @$user['name'] }},
					</p>
                    <p>
                        {{ _trans('emailTemplate.Employee Name ') }} {{ @$user['user_name'] }}, 
						({{ @$user['user_department'] }} {{ _trans('emailTemplate.Department') }}) {{ @$user['type'] }} {{ _trans('emailTemplate.will expire in a month') }}
                    </p>
					<br>
					<p>{{ _trans('emailTemplate.Expiry Date: ') }} {{ @$user['expire_date'] }}</p>

                    <p>
                        {{ _trans('emailTemplate.Please update the information') }}
                    </p>
                </div>
            </div>
            <!-- End template body -->
