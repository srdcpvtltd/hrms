            ...
            <div class="template-body">
                ...
                <div class="content-part">
                    ...
                    <p>{{ _trans('emailTemplate.Welcome!') }}
                        <br> {{ _trans('emailTemplate.You have registered on our site.') }}
                    </p>

                    <p> {{ _trans('emailTemplate.Here is account credentials') }}
                    </p>
                    <p>
                        <strong>{{ _trans('emailTemplate.Email') }}</strong> : {{ @$user->email }}
                        <br>
                        <strong>{{ _trans('emailTemplate.Password') }}</strong> : {{ @$password }}
                    </p>
                </div>
