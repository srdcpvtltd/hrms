...
class TaskDiscussionService extends BaseService
{
    ...
    public function store($request)
    {
        ...
        try {
            ...
            \App\Models\TaskManagement\TaskActivity::CreateActivityLog(getCUrrentCompany(), $project->id, auth()->id(), 'Created Discussion')->save();
            DB::commit();
    ...
    public function commentStore($request)
    {
        ...
        try {
            ...
            $comment->save();
            \App\Models\TaskManagement\TaskActivity::CreateActivityLog(getCUrrentCompany(), $discussion->task_id, auth()->id(), 'Created Discussion Comments')->save();
            DB::commit();
    ...
    function delete($id)
    {
        $discussion = $this->model->where(['id' => $id, 'company_id' => getCUrrentCompany()])->first();
        if (!$discussion) {
        ...
        try {
            ...
            $discussion->delete();            
            \App\Models\TaskManagement\TaskActivity::CreateActivityLog(getCUrrentCompany(), $discussion->task_id, auth()->id(), 'Deleted Discussion')->save();
            DB::commit();
    ...
    public function destroyAll($request)
    {
        try {
            if (@$request->ids) {
                $category = $this->model->where('company_id', getCUrrentCompany())->whereIn('id', $request->ids)->get();
