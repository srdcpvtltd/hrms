        ...
        return [
            'data' => $data->map(function ($data) {
                ...
                if ($data->attachment_file_id != null) {
                    ...
                    if ($uploaded['type'] == 'pdf') {
                        $upload_path = uploaded_asset($data->attachment_file_id);
                        $file = '<a href="' . $upload_path . '" target="_blank"> <i class="fas fa-file-pdf"></i> </a>';
                    } else {
                        $upload_path = uploaded_asset($data->attachment_file_id);
                        $file = '<a href="' . $upload_path . '" target="_blank"> <img height="40px" width="40px" src="' . url($upload_path) . '"/> </a>';
                    }
                }
