    ...
    function table($request)
    {
        ...
        return [
            'data' => $data->map(function ($data) {
                ...
                $amount_sign=$data->mode == 2 ? '%' : '';
                return [
                    'id' => $data->id,
                    'name' => $data->name,
                    'amount' => $data->amount.''.$amount_sign,
    ...
    function createAttributes()
    {
        return [
            ...
            'mode' => [
                ...
                'col' => 'col-md-12 form-group mb-3',
                'label' => _trans('common.Amount Mode'),
                'options' => [
                    [
                        'text' => _trans('payroll.Fixed'),
                        'value'  => 1,
                        'active' => false,
                    ],
                    [
                        'text' => _trans('payroll.Percentage'),
                        'value'  => 2,
                        'active' => true,
                    ],
                ]
            ...
            'mode' => [
                ...
                'options' => [
                    [
                        'text' => _trans('payroll.Fixed'),
                        'value'  => 1,
                        'active' => $commissionModel->mode == 1 ? true : false,
                    ],
                    [
                        'text' => _trans('payroll.Percentage'),
                        'value'  => 2,
                        'active' =>  $commissionModel->mode == 2 ? true : false,
                    ]
                ]
                    ],
            'type' => [
