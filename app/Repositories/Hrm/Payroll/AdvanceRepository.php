    ...
    function table($request)
    {
        ...
        return [
            'data' => $data->map(function ($data) {
                ...
                $amount = '';
                $amount .= '<span class="text-info">' . _trans('payroll.Requested') . ' : ' . currency_format($data->request_amount) . '</span><br>';
                $amount .= '<span class="text-success">' . _trans('payroll.Approved') . ' : ' . currency_format($data->amount ?? 0) . '</span> <br>';
                $amount .= '<span class="text-' . $class . '">' . _trans('payroll.Returned') . ' : ' . currency_format($data->paid_amount ?? 0) . '</span>';
                ...
                return [
                    ...
                    'payment'        => '<span class="badge badge-' . @$data->payment->class . '">' . @$data->payment->name . '</span>',
                    'return_status'  => '<span class="badge badge-' . @$data->returnPayment->class . '">' . @$data->returnPayment->name . '</span>',
                    'installment'    => '<span class="text-success">' . currency_format($data->installment_amount) . '</span>',
